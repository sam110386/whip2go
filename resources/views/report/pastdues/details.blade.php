                ...
                <form class="form-horizontal">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                @php
                                    $sd = $csorder->start_datetime ?? null;
                                    $stz = $csorder->timezone ?? config('app.timezone');
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                @php
                                    $ed = $lastOrder->end_datetime ?? null;
                                    $etz = $lastOrder->timezone ?? config('app.timezone');
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                @if(!empty($lastOrder->end_timing))
                                    @php
                                        $et = $lastOrder->end_timing;
                                        $etz2 = $lastOrder->timezone ?? config('app.timezone');
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                @php
                                    $cr = $lastOrder->created ?? null;
                                    $ctz = $lastOrder->timezone ?? config('app.timezone');
                        ...
                        <div class="form-group heading-divided-updown text-bold">
                            ...
                            <div class="col-lg-6">
                                @php
                                    $rent = (($subOrders->rent ?? 0) + ($subOrders->extra_mileage_fee ?? 0) + ($subOrders->dia_fee ?? 0));
                                @endphp
                                {{ $rent }}
                            </div>
                        </div>
                        ...
                        <div class="form-group heading-divided-updown text-bold">
                            ...
                            <div class="col-lg-6">
                                {{ sprintf('%0.2f', ((float) $tolls + (float) $insufee + (float) $rent + (float) $tax + (float) $initlafee)) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group heading-divided-updown text-bold">
                            ...
                            <div class="col-lg-6">
                                {{ ($lastOrder->end_odometer ?? 0) > 0 ? ($lastOrder->end_odometer - ($csorder->start_odometer ?? 0)) : 'N/A' }}
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                {{ ($OrderDepositRule->msrp ?? 0) - ($OrderDepositRule->initial_fee ?? 0) }}
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-lg-6 ">Vehicle Selling Price</label>
                            <div class="col-lg-6">{{ $OrderDepositRule->msrp ?? '' }}</div>
                        </div>

                        <div class="form-group">
                            <label class="col-lg-6 ">Vehicle Listing Price</label>
                            <div class="col-lg-6">{{ $OrderDepositRule->premium_msrp ?? '' }}</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">{{ $OrderDepositRule->num_of_days ?? '' }}</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                {{ sprintf('%0.2f', (($calculation['write_down_allocation'] ?? 0) * ($calculation['total_program_cost'] ?? 0) / 100)) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                {{ sprintf('%0.2f', (($calculation['maintenance_allocation'] ?? 0) * ($calculation['total_program_cost'] ?? 0) / 100)) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                {{ sprintf('%0.2f', (($calculation['total_program_fee_with_dia'] ?? 0) - ($calculation['total_program_fee_without_dia'] ?? 0))) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-6">Initial Fee</label>
                            <div class="col-lg-6">{{ $OrderDepositRule->initial_fee ?? '' }}</div>
                        </div>

                        <div class="form-group">
                            <label class="col-lg-6">Base Usage Rate</label>
                            <div class="col-lg-6">{{ $OrderDepositRule->base_rent ?? '' }}</div>
                        </div>

                        <div class="form-group">
                            <label class="col-lg-6">Included Miles</label>
                            <div class="col-lg-6">{{ $OrderDepositRule->miles ?? '' }}</div>
                        </div>

                        <div class="form-group">
                            <label class="col-lg-6">Extra Usage Rate</label>
                            <div class="col-lg-6">{{ $OrderDepositRule->emf_rate ?? '' }}</div>
                        </div>

                        <div class="form-group">
                            <label class="col-lg-6">Daily Program Miles</label>
                            <div class="col-lg-6">
                                {{ sprintf('%0.2f', $OrderDepositRule->miles ?? 0) }}</div>
                        </div>

                        <div class="form-group">
                            <label class="col-lg-6">Total Daily Rate</label>
                            <div class="col-lg-6">
                                {{ sprintf('%0.2f', $OrderDepositRule->rental ?? 0) }}</div>
                        </div>

                        <div class="form-group">
                            <label class="col-lg-6">Weekly Rate</label>
                            <div class="col-lg-6">
                                {{ sprintf('%0.2f', ($OrderDepositRule->rental ?? 0) * 7) }}</div>
                        </div>
                        
                        <div class="form-group">
                            <label class="col-lg-6">Monthly Rate</label>
                            <div class="col-lg-6">
                                {{ sprintf('%0.2f', ($OrderDepositRule->rental ?? 0) * 365 / 12) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                @php 
                                    $writedownallocation = (($calculation['write_down_allocation'] ?? 0) * ($downpaymentPaid ?? 0) / 100); 
                                @endphp
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                @php 
                                    $financeallocation = (($calculation['finance_allocation'] ?? 0) * ($downpaymentPaid ?? 0) / 100); 
                                @endphp
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                @php 
                                    $maintenanceallocation = (($calculation['maintenance_allocation'] ?? 0) * ($downpaymentPaid ?? 0) / 100); 
                                @endphp
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                @php 
                                    $dispositionfee = (($calculation['disposition_fee'] ?? 0) * ($downpaymentPaid ?? 0) / 100); 
                                @endphp
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6 text-bold">
                                {{ sprintf('%0.2f', ($writedownallocation + $financeallocation + $maintenanceallocation + $dispositionfee + ($totalDiaFee ?? 0))) }}
                            </div>
                        </div>

                    </div>

                    @if ($extlogs->isNotEmpty())
                        <div class="col-lg-6">
                            <div class="formgroup">
