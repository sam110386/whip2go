{{-- Port of Cake `app/View/Homes/index.ctp` — marketing landing. --}}
@extends('layouts.home')

@section('title', $title_for_layout ?? 'Whip Around Town Today')
            ...
            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2 no-pad text-center">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <div class="vehicle-subscription-box">
                        ...
                        <img src="{{ legacy_asset('img/vehicle-subscription-1.png') }}" alt="">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <div class="vehicle-subscription-box">
                        ...
                        <img src="{{ legacy_asset('img/vehicle-subscription-2.png') }}" alt="">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <div class="vehicle-subscription-box">
                        ...
                        <img src="{{ legacy_asset('img/vehicle-subscription-3.png') }}" alt="">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <div class="vehicle-subscription-box">
                        ...
                        <img src="{{ legacy_asset('img/vehicle-subscription-4.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2 no-pad text-center">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="how-it-works-list-item bg-white">
                        <img src="{{ legacy_asset('img/calendar.png') }}" alt="">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="how-it-works-list-item bg-white">
                        <img src="{{ legacy_asset('img/car.png') }}" alt="">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="how-it-works-list-item bg-white">
                        <img src="{{ legacy_asset('img/car-key.png') }}" alt="">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2 no-pad text-center">
                ...
                <div class="download-link text-center col-xs-12">
                    <a href="https://play.google.com/store/apps/details?id=com.carshare" target="_blank" rel="noopener noreferrer">
                        <img src="{{ legacy_asset('img/google-store.png') }}" alt="" class="img-responsive">
                    </a>
                    <a href="https://itunes.apple.com/in/app/whip-car-sharing/id1393803514?mt=8" target="_blank" rel="noopener noreferrer">
                        <img src="{{ legacy_asset('img/apple-store.png') }}" alt="" class="img-responsive">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2 no-pad">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="get-start-content">
                        ...
                        <a class="btn btn-primary btn-lg" role="button" href="/logins/index">Get Started</a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="get-start-content">
