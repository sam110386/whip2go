            ...
            <div class="row">
                <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2">
                    <div class="banner-content">
                        ...
                        <p>Vehicle subscriptions through your local dealership. Avoid the hassles of owning a vehicle.
                            Various subscription lengths available. Packages available for Ride Share drivers. Subscribe!
                        </p>
                    </div>
                    <form class="">
