    ...
    <div class="main-container">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    @if(session('success'))
                    <p class="text-success">{{ session('success') }}</p>@endif
                    @if(session('error'))
                    <p class="text-danger">{{ session('error') }}</p>@endif
                    ...
                    <div class="panel" style="margin-top:20px;">
                        <div class="panel-body">
                            <form method="post" action="/homes/support" class="form-horizontal" id="CustomerContact">
                                @csrf
                                <fieldset>
                                    <legend class="text-semibold"><i class="icon-reading position-left"></i> Contact
                                    </legend>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">First Name:</label>
                                            <div class="col-lg-9">
                                                <input type="text" name="Contact[first_name]" class="form-control required"
                                                    value="{{ old('Contact.first_name') }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">Last Name:</label>
                                            <div class="col-lg-9">
                                                <input type="text" name="Contact[last_name]" class="form-control required"
                                                    value="{{ old('Contact.last_name') }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="email" name="Contact[email]"
                                                    class="form-control email required" value="{{ old('Contact.email') }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <textarea name="Contact[comment]" class="form-control" rows="5" cols="5"
                                                    ...
                                                    required>{{ old('Contact.comment') }}</textarea>
                                            </div>
                                        </div>
