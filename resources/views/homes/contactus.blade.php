    ...
    <div class="main-container">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <center>
                        <h1>Fill below form if you want to delete your account</h1>
                    </center>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-xs-12">
                                    ...
                                    <form method="post" action="/contactus" class="form-horizontal" name="frmadmin"
                                        id="CustomerContact" onsubmit="return isvalid()">
                                        @csrf
                                        <fieldset>
                                            <legend class="text-semibold"><i class="icon-reading position-left"></i> General
                                                details</legend>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <textarea name="Contact[comment]" class="form-control" rows="5"
                                                            cols="5"
                                                            placeholder="Enter your message here">{{ old('Contact.comment') }}</textarea>
                                                    </div>
                                                </div>
