            ...
            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2">
                <div class="banner-content">
                    ...
                    <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2 no-pad text-center">
                        <div class="col-md-6">
                            <a href="https://itunes.apple.com/in/app/whip-car-sharing/id1393803514?mt=8" target="_blank" class=" btn btn-default btn-rounded pull-right">
                                App Store</a>
                        </div>
                        <div class="col-md-6">
                            <a href="https://play.google.com/store/apps/details?id=com.carshare" target="_blank" class=" btn btn-default btn-rounded pull-left">
                                Play Store
                            </a>
                        </div>
            ...
            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2 no-pad text-center">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <div class="vehicle-subscription-box">
                        ...
                        <img src="{{ legacy_asset('img/driveitaway_vehicle-subscription-4.png') }}" alt="" style="width: 150px;margin-left: -8px;">
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2 no-pad text-center">
                ...
                <div class="letsbegan">
                    <div class="col-md-12">
                        <ol>
                            <li> You'll be spending a lot of time together! Find the exact car you want before committing to leasing or buying. Don't just get in any rental. You're better than that!</li>
                            <li> Invest in your car! This may be the one. Temp payments may be used towards purchasing the car if you decide to buy it.</li>
                            <li> After days and months together, we've gotten to know each other. Build your credit through the temporary vehicle with our available credit repair program.</li>
                            <li> Exclusive to DriveItAway, we have incentives to help you pay for your vehicle up to $1000. And, we don't charge the 10% driver fees nor background check fees like some other folks.</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2 no-pad ">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="get-start-content">
                        ...
                        <a class="btn btn-primary btn-lg" role="button" href="/logins/index" style="border:medium solid #fff;">Get Started</a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="get-start-content">
