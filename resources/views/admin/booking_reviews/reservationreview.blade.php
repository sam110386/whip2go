                ...
                <h4>
                    ...
                    <div class="heading-elements">
                        <div class="heading-btn-group">
                            <button type="submit" form="frmadmin" class="btn btn-primary">Save <i
            ...
            <div class="col-lg-7">
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{ $basePath }}/reservationreview/{{ base64_encode((string) $orderid) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <textarea name="CsOrderReview[details]" rows="5"
                                        class="form-control">{{ $cr['details'] ?? '' }}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="panel-body">
                        ...
                        @if(!empty($pickup_data) && !empty($pickup_data['LicenseDetail']))
                            <div class="col-lg-12">
                                ...
                                <pre class="content-group language-markup"
                                    style="padding: 10px; background: #f8f8f8; border: 1px solid #ddd;"><code class="language-markup">@php print_r($pickup_data['LicenseDetail']); @endphp</code></pre>
                            </div>
                        @endif
                                ...
                                @foreach($pickup_data['LICENSEDOC'] as $doc)
                                    <a href="{{ legacy_asset('files/reservation/' . $doc) }}" target="_blank">
                                        <img height="150px" width="150px" src="{{ legacy_asset('files/reservation/' . $doc) }}"
                                            class="img-thumbnail" style="margin-right:5px; margin-bottom:5px;" />
                                    </a>
                                @endforeach
                            </div>
                        @endif
