        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form method="post" action="{{url('/admin/booking_reviews/initial/' . base64_encode($orderid)) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                ...
                                <a href="{{url('/admin/booking_reviews/nonreview')}}" class="btn left-margin btn-cancel">
                                    Cancel
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Review Images</label>
                        <div class="col-lg-9">
                ...
                <div class="col-lg-6">
                    ...
                    @if(!empty($pickupData) && !empty($pickupData['LicenseDetail']))
                        <div class="col-lg-12">
                            ...
                            <pre
                                class="content-group language-markup"> <code class="language-markup">{{ print_r($pickupData['LicenseDetail'], true) }}</code> </pre>
                        </div>
                    @endif
