            ...
            <tr>
                @include('partials.dispacher.sortable_header', [
                    'columns' => [
                        ...
                        ['title' => 'Actions', 'sortable' => false, 'style' => 'text-align:center;'],
                    ]
                ])
            </tr>
        </thead>
                    ...
                    <td>
                        <span class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-solid pull-right">
                                <li>
                                    <a href="javascript:void(0);" title="Reopen Booking" onclick="return reopenbooking('{{ base64_encode($trip->id) }}');">
                                        <i class="icon-arrow-left52"></i>
                                        Reopen Booking
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" title="Vehicle Review Report" onclick="return getreviewpopup('{{ base64_encode($trip->id) }}');">
                                ...
                                <li>
                                    <a href="javascript:void(0);" title="Reopen Booking" onclick="return gettransactionlogs('{{ base64_encode($trip->id) }}');">
                                        <i class="icon-coin-dollar"></i> 
                                        Transaction logs
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" title="Scan Vehicle" onclick="return getVehicleScanRequestPopup('{{ base64_encode($trip->id) }}');">
                                        <i class="icon-search4"></i> 
                                        Scan Vehicle
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" title="Booking Notes" onclick="return getBookingNotes('{{ base64_encode($trip->id) }}');">
