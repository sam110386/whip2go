...
@section('title', 'Manage Charge Back')
...
@section('content')
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    ...
                    <span class="text-semibold">Dealer</span> - Charge Back
                </h4>
            </div>
            <div class="heading-elements">
                <a href="{{ url('admin/charge_back/dealer_chargebacks/payment') }}" class="btn btn-success">New Charge</a>
            </div>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="panel-body">
            <form id="frmSearchadmin" name="frmSearchadmin" method="GET" action="{{ url('admin/charge_back/dealer_chargebacks/index') }}">
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-3">
                            Dealer :
