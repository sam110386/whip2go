...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Bulk</span> -Lead Import</h4>
        </div>
    </div>
</div>
<div class="row">
...
<div class="panel">
    <div class="row">
        <form action="/admin/hitch/leads/import" method="POST" name="frmadmin" id="frmadmin" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            <div class="panel-body">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="dealer_id" id="HitchLeadDealerId" class="required" style="width:100%">
                        </div>
                    </div>
                    <div class="form-group">
