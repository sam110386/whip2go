            ...
            <div class="panel-body">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="HitchLead[dealer_id]" id="HitchLeadDealerId" class="required" style="width:100%" value="{{ $lead->dealer_id ?? '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Phone :<span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <input type="text" name="HitchLead[phone]" maxlength="12" class="form-control phone required" value="{{ $lead->phone ?? '' }}" {{ !empty($lead->id ?? null) ? 'readonly' : '' }}>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">First Name :<span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <input type="text" name="HitchLead[first_name]" class="form-control required" value="{{ $lead->first_name ?? '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Last Name :<span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <input type="text" name="HitchLead[last_name]" class="form-control required" value="{{ $lead->last_name ?? '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Email :</label>
                        <div class="col-lg-9">
                            <input type="text" name="HitchLead[email]" class="form-control email" value="{{ $lead->email ?? '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            ...
                            @endif
                            <button type="button" class="btn left-margin btn-cancel" onclick="goBack('/admin/hitch/leads/index')">Return</button>
                        </div>
                    </div>
                </div>
            </div>
