...
@section('title', 'Manage Hitch Leads')
...
@section('content')
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    ...
                    <span class="text-semibold">Hitch</span> - Leads
                </h4>
            </div>
            <div class="heading-elements">
                <a href="{{ url('admin/hitch/leads/add') }}" class="btn btn-success">Add New</a>
                <a href="{{ url('admin/hitch/leads/import') }}" class="btn btn-success">Bulk Import</a>
            </div>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="panel-body">
            <form id="frmSearchadmin" name="frmSearchadmin" method="GET" action="{{ url('admin/hitch/leads/index') }}">
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-3">
                            Keyword :
