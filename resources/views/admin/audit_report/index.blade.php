...
@section('title', $title ?? 'Manage Audit Reports')
...
@section('content')
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    ...
                    <span class="text-semibold">Audit</span> - Reports
                </h4>
            </div>
            <div class="heading-elements">
                <a href="{{ url('admin/audit_reports/add') }}" class="btn btn-success">
                    {{ 'Add New' }}
                </a>
            </div>
        </div>
    ...
    <div class="panel">
        <div style="width:100%; overflow: visible;" id="postsPaging" class="panel-body">
            @include('admin.audit_report.elements.index')
        </div>
    </div>
