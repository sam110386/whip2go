...
<div class="panel">
    <div class="row">
        <form action="{{ url('admin/audit_report/audit_reports/add') }}" method="POST" id="frmadmin" class="form-horizontal">
            @csrf
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            ...
                            <button type="button" class="btn left-margin btn-cancel" onclick="goBack('/admin/audit_report/audit_reports/index')">Return</button>
                        </div>
                    </div>
                </div>
            </div>
