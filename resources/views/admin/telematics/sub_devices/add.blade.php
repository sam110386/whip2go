    ...
    <form action="#" method="POST" id="AddDevice" class="form-horizontal">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <input type="text" name="TelematicsDevice[device_name]" class="required form-control"
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <input type="text" name="TelematicsDevice[gps_serialno]" class="required form-control"
                        value="{{ $device->gps_serialno ?? '' }}">
                </div>
            </div>
        </fieldset>
