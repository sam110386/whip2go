...
@section('content')
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    ...
                    <span class="text-semibold">Manage </span>- Telematics Subscriptions
                </h4>
            </div>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="panel-body">
            <form action="/admin/telematics_subscriptions/index" method="POST" id="frmSearchadmin" name="frmSearchadmin"
