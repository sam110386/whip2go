...
@section('content')
    ...
    <form method="post" action="{{ url('/admin/leases/create_vehicle_lease/' . ($vehicleIdEncoded ?? '')) }}" name="triplogForm" id="triplogForm" class="form-horizontal">
        @csrf
        <div class="row">
            <div class="col-sm-5">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="hidden" name="data[CsLease][user_id]" value="{{ old('data.CsLease.user_id', $lease['user_id'] ?? ($v['user_id'] ?? '')) }}">
                                </div>
                            </div>
                            <div class="form-group">
