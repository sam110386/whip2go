                ...
                <tr>
                    ...
                    <td>
                        @if(!empty($record->logo))
                            <img src="{{ legacy_asset('img/insurance_providers/' . $record->logo) }}" width="80" height="80" />
                        @endif
                    </td>
                    <td>
                        {{ $record->name }}
                    ...
                    <td>
                        &nbsp;
                        <a href="{{ url('/admin/insurance_providers/add/' . base64_encode($record->id)) }}">
                            <i class="glyphicon glyphicon-edit"></i>
                        </a>
                        &nbsp;
                        <a href="{{ url('/admin/insurance_providers/delete/' . base64_encode($record->id)) }}">
