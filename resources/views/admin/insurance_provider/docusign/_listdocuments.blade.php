...
<div class="modal-body">
    ...
    <div class="panel-body">
        <div class="row">
            @if(empty($docusignEnvelopeId) || empty($envelopObj))
                <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <label class="col-lg-5 control-label">
                                    <a href="javascript:void(0)"
                                        onclick="PullDocusignSignedDocument('{{ $docusignEnvelopeId }}','{{ $document['document_id'] }}','{{ $orderDepositRuleId }}','{{ $document['name'] }}')">
                                        {{ $document['name'] }}
                                    </a>
                                </label>
                            </div>
