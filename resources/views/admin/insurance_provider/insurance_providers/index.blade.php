...
@section('title', 'Manage Insurance Providers')
...
@section('content')
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    ...
                    <span class="text-semibold">Insurance</span> - Providers
                </h4>
            </div>
    ...
    <div class="panel">
        <div class="panel-body">
            <form id="frmSearchadmin" name="frmSearchadmin" method="GET" action="{{ url('/admin/insurance_providers/index') }}">
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-3">
                            Keyword :
