            ...
            <div class="panel-body">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="InsuranceProvider[name]" class="form-control required" value="{{ old('InsuranceProvider.name', $record->name ?? '') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Address :</label>
                        <div class="col-lg-9">
                            <input type="text" name="InsuranceProvider[address]" class="form-control" value="{{ old('InsuranceProvider.address', $record->address ?? '') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">City :</label>
                        <div class="col-lg-9">
                            <input type="text" name="InsuranceProvider[city]" class="form-control" value="{{ old('InsuranceProvider.city', $record->city ?? '') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Country :</label>
                        <div class="col-lg-9">
                            <select name="InsuranceProvider[country]" id="InsuranceProviderCountry" class="form-control">
                    ...
                    <div class="form-group {{ (old('InsuranceProvider.country', $record->country ?? '') == 'US' || empty(old('InsuranceProvider.country', $record->country ?? ''))) ? '' : 'hide' }}" id="usstate">
                    ...
                    <div class="form-group {{ old('InsuranceProvider.country', $record->country ?? '') != 'CA' ? 'hide' : '' }}" id="castate">
                        <label class="col-lg-3 control-label">State :</label>
                        <div class="col-lg-9">
                            <select name="InsuranceProvider[castate]" class="form-control">
                                @foreach($caStates as $code => $name)
                                    <option value="{{ $code }}" {{ old('InsuranceProvider.castate', $record->castate ?? '') == $code ? 'selected' : '' }}>{{ $name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="url" name="InsuranceProvider[link]" class="form-control" value="{{ old('InsuranceProvider.link', $record->link ?? '') }}">
                        </div>
                    </div>
                    <div class="form-group">
