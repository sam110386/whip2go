    ...
    <div class="page-header-content">
        ...
        <div class="heading-elements">
            <div class="input-group-btn">
                <a href="{{ url('/admin/lead/leads/add') }}" class="btn btn-success" style="float:right;">Add New</a>
            </div>
        </div>
    </div>
</div>
...
<div class="panel">
    <div class="panel-body">
        <form action="{{ url('/admin/lead/leads/index') }}" method="POST" id="frmSearchadmin" class="form-horizontal">
            @csrf
            <div class="row pb-10">
                <div class="col-md-2">
