...
<div class="panel-body">
    <form id="menuform">
        <div class="form-group">
            ...
            <input type="text" class="form-control required" name="AdminModule[module]" maxlength="100"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control required" name="AdminModule[module_url]"
                value="{{ old('data.AdminModule.module_url', (string) data_get($module, 'module_url', '')) }}">
        </div>

        <div class="form-group">
            <label style="display:block; font-weight:700;">
                HTML ID :<span class="text-danger">*</span>
            </label>
            <input type="text" class="form-control required" name="AdminModule[html_id]"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control required" name="AdminModule[icon]"
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="AdminModule[parent_id]">
        ...
        <input type="hidden" name="AdminModule[id]" value="{{ data_get($module, 'id', '') }}" class="form-control">
