    ...
    <form action="#" method="post" id="cancelForm" class="form-horizontal">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <input type="text" name="Text[cancellation_fee]" class="number form-control"
                        placeholder="Cancellation Fee" value="{{ $cancellation_fee }}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <input type="text" name="Text[cancel_note]" class="form-control" placeholder="Cancel Note if any"
                        value="">
                </div>
            </div>
