        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    ...
                    <span class="text-semibold">Recalculate </span> - Goal
                </h4>
            </div>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6">
                    <form id="VehicleOfferForm" class="form-horizontal" method="POST">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <label class="col-lg-4 control-label">
                                    Selling Price:<font class="requiredField">*</font>
                                </label>
                                <div class="col-lg-7">
                                    <input type="text" name="VehicleOffer[totalcost]" class="required form-control number"
                                        value="{{ $depositRule->totalcost }}" maxlength="16">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-lg-4 control-label">
                                    Goal:<font class="requiredField">*</font>
                                </label>
                                <div class="col-lg-7">
                                    <select name="VehicleOffer[goal]" class="required form-control select2">
                                        ...
                                        @foreach(['20', '30', '40', '50', '60', '70', '80', '90', '100'] as $val)
                                            <option value="{{ $val }}" {{ $depositRule->goal == $val ? 'selected' : '' }}>
                                                {{ $val }}%
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <input type="text" name="VehicleOffer[downpayment]" class="required form-control number"
                                        value="{{ $depositRule->downpayment }}" readonly>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-lg-4 control-label">
                                    Target Program Length (Days):<font class="requiredField">*</font>
                                </label>
                                <div class="col-lg-7">
                                    <input type="text" name="VehicleOffer[target_days]" class="required form-control digit"
                                        value="{{ $depositRule->num_of_days }}" maxlength="5">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-lg-4 control-label">
                                    Choose Miles Per Month:<font class="requiredField">* </font>
                                </label>
                                <div class="col-lg-7">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <label class="col-lg-4 control-label">
                                    Pricing Type:<font class="requiredField">*</font>
                                </label>
                                <div class="col-lg-7">
                                    <select name="VehicleOffer[fare_type]" class="required form-control">
                                        <option value="D" {{ $depositRule->fare_type == 'D' ? 'selected' : '' }}>
                                            Dynamic
                                        </option>
                                        <option value="S" {{ $depositRule->fare_type == 'S' ? 'selected' : '' }}>
                                            Static
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="VehicleOffer[deposit_amt]" class="form-control"
                                        placeholder="Deposit" value="{{ $depositRule->deposit_amt }}">
                                </div>
                            </div>
                                        ...
                                        <div class="form-group" id="ele-dep-{{ $i }}">
                                            ...
                                            <div class="col-lg-3 calwrap">
                                                <input type="text" name="VehicleOffer[deposit_opt][{{ $i }}][after_day_date]"
                                                    ...
                                                    value="{{ !empty($val['after_day_date']) ? date('m/d/Y', strtotime($val['after_day_date'])) : '' }}">
                                            </div>
                                            <div class="col-lg-1">Amount</div>
                                            <div class="col-lg-2">
                                                <input type="text" name="VehicleOffer[deposit_opt][{{ $i }}][amount]"
                                                    class="form-control" placeholder="amount" value="{{ $val['amount'] ?? '' }}">
                                            </div>
                                        </div>
                                        @php
                                            $i++; 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="VehicleOffer[initial_fee]" class="form-control"
                                        placeholder="Initial Fee" value="{{ $depositRule->total_initial_fee }}">
                                </div>
                            </div>
                                ...
                                @if(!empty($initialFeeOpt))
                                    @foreach($initialFeeOpt as $val)
                                        <div class="form-group" id="ele-ini-{{ $j }}">
                                            ...
                                            <div class="col-lg-3 calwrap">
                                                <input type="text" name="VehicleOffer[initial_fee_opt][{{ $j }}][after_day_date]"
                                                    class="calendar form-control"
                                                    value="{{ !empty($val['after_day_date']) ? date('m/d/Y', strtotime($val['after_day_date'])) : '' }}">
                                            </div>
                                            <div class="col-lg-1">Amount</div>
                                            <div class="col-lg-2">
                                                <input type="text" name="VehicleOffer[initial_fee_opt][{{ $j }}][amount]"
                                                    class="form-control" placeholder="amount" value="{{ $val['amount'] ?? '' }}">
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6" id="calculations">
                                    <ul>
                                        <li>
                                            <strong>Total Program Cost:</strong> {{ $depositRule->total_program_cost }}
                                        </li>
                                        <li>
                                            <strong>Program Fee:</strong> {{ $depositRule->program_fee }}
                                        </li>
                                        <li>
                                            <strong>Insurance Cost To Driver:</strong> {{ $depositRule->total_insurance }}
                                        </li>
                                        <li>
                                            <strong>Day Rent:</strong> {{ $depositRule->rental }}
                                        </li>
                                        <li>
                                            <strong>Day EMF:</strong> {{ $depositRule->emf }}
                                        </li>
                                        <li>
                                            <strong>Day Insurance:</strong> {{ $depositRule->insurance }}
                                        </li>
                                        <li>
                                            <strong>Day Miles:</strong> {{ ceil(($depositRule->miles ?? 0) * 30) }}
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <button type="button" class="btn left-margin btn-large" onClick="calculateFareMatrix()"
                                    id="calculateButton">
                                    Calculate
                                </button>
                                <button type="button" class="btn btn-primary" disabled onClick="saveRecalculation()"
                                    id="saveGoalRecalculation">
                                    Update
                                </button>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <form action="{{ url('admin/bookings/savemanualcalculation') }}" method="POST" id="VehicleOfferEditForm"
                        ...
                        @foreach(data_get($depositRule, 'calculation', []) as $key => $calculate)
                            ...
                            <div class="form-group">
                                <label class="col-lg-4 control-label">
                                    {{ ucwords(str_replace('_', ' ', $key)) }}:<font class="requiredField">*</font>
                                </label>
                                <div class="col-lg-7">
