...
@section('title', $title ?? 'Add Mechanical Issue')
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group">
                            ...
                            <input type="text" name="CsVehicleIssue[service_paid]" id="CsVehicleIssueServicePaid"
                                class="form-control digit" value="{{ data_get($vehicleIssue, 'service_paid', '') }}">
                        </div>
                    </div>
                </div>
                <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $(".fileinputajax").fileinput({
                ...
                maxFileSize: 1024, uploadExtraData: function () {
                    return {
                        id: $("#CsVehicleIssueId").val(), _token: '{{ csrf_token() }}'
                    };
                },
                fileActionSettings: {
                    showDrag: false,
        ...
        function saveForm() {
            if ($("#frmadmin").valid()) {
                ...
                $.post(
                    SITE_URL + 'admin/vehicle_issues/saveAdd',
