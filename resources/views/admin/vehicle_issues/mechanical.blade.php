...
function saveForm() {
    if ($("#frmadmin").valid()) {
        ...
        $.post(SITE_URL+'admin/vehicle_issues/saveAdd', $("#frmadmin").serialize(), function(data) {
