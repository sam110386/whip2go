...
@section('title', $title ?? 'Add Cleaning Request')
    ...
    <div class="panel">
        <form method="POST" name="frmadmin" id="frmadmin" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label">
                        Request Details: <font class="requiredField">*</font></label>
                    <div class="col-lg-4">
                        <textarea name="CsVehicleIssue[roadside_request_detail]"
                            class="textfield required form-control">{{ data_get($vehicleIssue, 'roadside_request_detail', '') }}</textarea>
                        <em>Request details if any</em>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label">
