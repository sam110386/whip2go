...
@section('title', $title ?? 'Pending Booking Related Request')
...
@section('content')
    ...
    <div class="panel">
        <form action="{{ url('/admin/vehicle_issues/pendingBooking/' . $id) }}" method="POST" name="frmadmin" id="frmadmin"
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="CsVehicleIssue[vehicle_id]" id="CsVehicleIssueVehicleId"
                            ...
                            placeholder="Select Vehicle.." style="width:100%;" readonly>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4 control-label text-bold">
                        {!! $checklist !!}
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label">
                        Note: <font class="requiredField">*</font>
                    </label>
                    <div class="col-lg-4">
                        <textarea name="CsVehicleIssue[notes]"
                            class="textfield required form-control">{{ $notes }}</textarea>
                        <em> Details if any</em>
                    </div>
                </div>
                <div class="form-group">
