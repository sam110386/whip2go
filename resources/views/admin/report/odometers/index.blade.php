...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Vehicle Odometer</span> - Reports</h4>
        </div>
    </div>
</div>
<div class="row ">
...
<div class="panel">
    <form method="POST" action="{{ url('/admin/report/odometers') }}" class="form-horizontal">
        @csrf
        <div class="panel-body">
            ...
            <div class="col-md-2">
                <button type="submit" name="search" value="EXPORT" class="btn btn-warning">EXPORT</button>
            </div>
        </div>
    </form>
</div>
