...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Revenue</span> - Report</h4>
        </div>
    </div>
</div>
<div class="row ">
...
<div class="panel">
    <form method="POST" action="{{ url('/admin/report/summary/generatereport') }}" class="form-horizontal">
        @csrf
...
<script>
    $(function(){
        jQuery.blockUI({
            message: '<h1><img src="{{ config('app.url') }}/img/select2-spinner.gif" /> Hold On, we are generating report...</h1>',
            css: {'z-index': '9999'}
        });
        ...
        $.post("{{ url('/admin/report/summary/processReport') }}", {
            ...
            jQuery.unblockUI();
            window.location="{{ config('app.url') }}/admin/report/summary";
        });
    });
</script>
@endif
