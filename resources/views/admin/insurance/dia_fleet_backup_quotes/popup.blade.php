...
<div class="modal-body">
    <div class="panel-body">
        ...
        <div class="col-lg-12 col-sm-12">
            ...
            <div class="form-group">
                <div class="col-lg-12 mt-2 text-center mt-10">
                    <button type="button" class="btn btn-primary pl-3 pr-3" onclick="SaveDiaFleetBackupQuoteUploadPopUp('{{ $myModal }}')">Save <i class="icon-arrow-right14 position-right"></i></button>
                    <button type="button" class="btn btn-primary pl-3 pr-3" onclick="SaveDiaFleetBackupQuoteUploadPopUp('{{ $myModal }}',true)">Approve & Save <i class="icon-arrow-right14 position-right"></i></button>
                </div>
            </div>
        ...
        <div class="col-lg-12 col-sm-12">
            ...
            <div class="form-group">
                <div class="col-lg-12 mt-2 text-center mt-10">
                    <button type="button" class="btn btn-primary pl-3 pr-3" onclick="SaveDiaFleetBackupPolicyDetails('{{ $myModal }}')">Save <i class="icon-arrow-right14 position-right"></i></button>
                </div>
            </div>
            <input type="hidden" name="data[DriverFinancedInsuranceQuote][id]" value="{{ $quoteData['id'] ?? '' }}">
            <input type="hidden" name="data[DriverFinancedInsuranceQuote][order_id]" value="{{ $recordid }}">
