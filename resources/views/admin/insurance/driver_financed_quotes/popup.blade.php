...
<div class="modal-body">
    <div class="panel-body">
        ...
        <div class="col-lg-12 col-sm-12">
            <a href="javascript:void(0)" onclick="(function(){window.open('{{ config('app.url') }}/insurance/roi/diafinancedreview/{{ $orderandusers }}/true','diawindow','directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=850');return false;})();" class="btn btn-info">Update Details By Driver</a>
        </div>
        @endif
        <div class="col-lg-12 col-sm-12">
