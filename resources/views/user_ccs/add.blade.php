...
<div class="row">
    <fieldset class="col-lg-12">
        <form method="post" action="/user_ccs/add/{{ $useridB64 }}" name="frmadmin" id="frmadmin" class="form-horizontal">
            @csrf
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-lg-2 control-label">Card Holder Name :<span class="text-danger">*</span></label>
                    <div class="col-lg-4">
                        <input type="text" name="UserCcToken[card_holder_name]" maxlength="50" class="form-control required" value="{{ old('UserCcToken.card_holder_name') }}">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="UserCcToken[address]" maxlength="150" class="form-control required" value="{{ old('UserCcToken.address') }}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label">City :<span class="text-danger">*</span></label>
                    <div class="col-lg-4">
                        <input type="text" name="UserCcToken[city]" maxlength="50" class="form-control required" value="{{ old('UserCcToken.city') }}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label">State :<span class="text-danger">*</span></label>
                    <div class="col-lg-4">
                        <select name="UserCcToken[state]" class="form-control required">
                            @foreach($stateOptions as $abbr => $name)
                                <option value="{{ $abbr }}" @selected(old('UserCcToken.state') === $abbr)>{{ $name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="UserCcToken[zip]" maxlength="50" class="form-control required" value="{{ old('UserCcToken.zip') }}">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <button type="button" class="btn left-margin btn-cancel" onclick="window.location.href='/users/index'">Return</button>
                    </div>
                </div>
            </div>
