                    ...
                    <div class="panel panel-body login-form">
                        ...
                        <div class="panel-body">
                            <div class="text-center">
                                ...
                                <h5 class="content-group-lg">Verify Account</h5>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group has-feedback">
                                        <input name="User[activationCode]" maxlength="14" class="form-control required" placeholder="Enter activation code">
                                        <div class="form-control-feedback"><i class="icon-user-lock text-muted"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="text-right">
                                <a class="btn btn-link" href="{{ url('/logins/resendActivation') }}"><i class="icon-arrow-left13 position-left"></i> Resend</a>
