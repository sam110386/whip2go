            ...
            <div class="content">
                <form action="{{ url('/logins/index') }}" method="POST" id="userlogin" name="userlogin">
                    ...
                    <div class="panel panel-body login-form">
                        ...
                        <div class="form-group has-feedback has-feedback-left">
                            <input name="User[user_password]" type="password" class="form-control required" placeholder="Password">
                        ...
                        <a href="{{ url('/logins/pre_register') }}" class="btn bg-pink btn-block content-group">Sign up</a>
                    </div>
                </form>
            </div>
        </div>
