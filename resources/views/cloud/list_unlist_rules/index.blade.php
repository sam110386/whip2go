...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        <form action="{{ $formUrl }}" method="POST" id="ListUnlistRuleIndexForm" class="form-horizontal">
            @csrf
            ...
            <div id="unlist-ymm-block" class="form-group {{ ($listingRule !== 'unlist_by_ymm') ? 'hidden' : '' }}">
