...
<div class="panel">
    <div class="panel-body">
        <div class="form-group">
            @if($booking['OrderDepositRule']['insurance_payer'] == 5)
                ...
                <div class="col-lg-6 col-sm-12 text-left">
                    @foreach($providers as $provider)
                        ...
                        <div class="provider-list mt-20">
                            <a href="{{ url('insurance/roi/diafinancedpopup/' . $orderandusers . '/' . $provider['InsuranceProvider']['id']) }}" class="btn btn-primary w-100">Upload screenshot and quote #</a>
                        </div>
                    @endforeach
                </div>
            @endif
