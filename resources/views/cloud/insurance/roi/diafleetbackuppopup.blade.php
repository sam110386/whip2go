...
<script type="text/javascript">
    $(document).ready(function() {
        $("#DriverFinancedInsuranceDiafleetbackuppopupForm").validate();
    });
</script>
<div class="panel">
    <form action="{{ url('insurance/roi/diafleetbackupsave/' . $orderandusers) }}" method="POST" name="frmadmin" id="DriverFinancedInsuranceDiafleetbackuppopupForm" class="form-horizontal" enctype="multipart/form-data">
    @csrf
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#DriverFinancedInsuranceSave").click(function(){
            if($("#DriverFinancedInsuranceDiafleetbackuppopupForm").valid()){
        ...
        $('#InsurancePayerQuoteDoc').fileinput({
            ...
            $("#DriverFinancedInsuranceDiafleetbackuppopupForm").submit();
