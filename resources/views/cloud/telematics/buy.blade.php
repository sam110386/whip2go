...
@section('content')
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    ...
                    <span class="text-semibold">Buy-</span> Telematics
                </h4>
            </div>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="row">
            <form action="/telematics_subscriptions/buy" method="POST" name="frmadmin" id="frmadmin"
                    ...
                    @if(isset($unit) && isset($subcriptionamt))
                        <div class="col-lg-7">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="col-lg-5 control-label">Card Holder Name :<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-7">
                                        <input type="text" name="UserCcToken[card_holder_name]" size="30" maxlength="50"
                                            class="form-control required" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-5 control-label">Credit Card # :<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-7">
                                        <input type="text" name="UserCcToken[credit_card_number]"
                                            id="UserCcTokenCreditCardNumber" size="30" maxlength="25"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <select name="UserCcToken[card_type]" id="UserCcTokenCardType"
                                            class="form-control required">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" name="UserCcToken[expiration]" id="UserCcTokenExpiration" size="30"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" name="UserCcToken[cvv]" id="UserCcTokenCvv" size="30" maxlength="4"
                                            class="form-control required">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" name="UserCcToken[address]" maxlength="150"
                                            class="form-control required" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" name="UserCcToken[city]" maxlength="50" class="form-control required"
                                            value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" name="UserCcToken[zip]" size="30" maxlength="50" class="form-control"
                                            value="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="formgroup pull-left" style="width:100%">
                                ...
                                <div class="col-lg-4">
                                    <span
                                        class="help-block">(${{ config('legacy.TELEMATICUNITMONTHSERVICE', 0) }}x{{ $unit }})</span>
                                </div>
                            </div>
                            <div class="formgroup pull-left" style="width:100%">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <button type="button" class="btn left-margin btn-cancel"
                                        onclick="goBack('/telematics_subscriptions/index')">Return</button>
                                </div>
                            </div>
                        </div>
                    @else
                        <div class="col-lg-12">
                            ...
                            <p>One time charge of $45 per OBDII and Hardwired GPS unit. Fleet Plug-n-Play combination quickly
                                identifies the vehicle by VIN, monitor vehicle diagnostics and utilize starter interrupt. Ideal
                                for quick transfers of GPS unit from one vehicle to the next, without the need to manually input
                                the GPS unit # and attached it to a new vehicle in the system. Added benefit of grabbing
                                odometer at install and not just tracking GPS travel distances. Ability to grab fuel levels and
                                other fleet advantages (dependent on OEM).</p>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="number" name="TelematicsSubscription[units]" maxlength="3" step="1"
    ...
    <script type="text/javascript">
        ...
        function makePayment() {
            if (jQuery("#frmadmin").valid()) {
                ...
                jQuery.post('{{ config("app.url") }}/telematics_subscriptions/buypayment', formdata, function (resp) {
                    if (resp.status == 'success') {
                        alert('Your subscription is created successfully. We will contact you shortly.');
                        goBack('/telematics_subscriptions/index');
                    } else {
                        alert(resp.message);
                    }
