...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('theme2/icons/fontawesome/styles.min.css') }}">
...
<body>
    <div class="navbar navbar-default header-highlight">
        <div class="navbar-header">
            <a class="navbar-brand" href="javascript:void(0);"><span style="color:#fff; font-size:18px;">DriveItAway</span></a>
        </div>
    </div>
