...
<head>
    ...
    <script src="{{ asset('js/assets/js/plugins/forms/selects/bootstrap_multiselect.js') }}"></script>
    ...
    <script src="{{ asset('js/assets/js/plugins/forms/validation/additional_methods.min.js') }}"></script>
...
<body>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <span class="pull-right topcontainertext">
                            <h6>{{ 'Dealers. This platform was built for your vehicles.' }}
                                <br>
                                {{ 'Earn up to $1100 per month for each car on your lot!' }}
                            </h6>
                        </span>
                    </div>
                    <div class="col-md-6 ">
                        <a href="{{ url('/logins/index') }}" title="Get Started" class="btn btn-getstarted pull-left">
                            {{ 'Get Started' }}
                        </a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-pad">
                        <div class="col-md-12 no-pad ">
                            <div class="col-md-3">
                                <i class="icon-mobile driveitawaycolor"></i> <span
                                    class="text-white text-size-12">{{ env('SUPPORT_PHONE', '') }}</span>
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-pad">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="{{ url('/') }}">
                                <img src="{{ asset('img/driveitaway-logo-blue.svg') }}" alt="Drive IT AWAY"
                        ...
                        <div class="collapse navbar-collapse" id="main-navbar">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                @else
                                    <li><a href="{{ url('/logins/index') }}" title="Login">{{ 'Login' }}</a>
                                    </li>
                                @endif
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <div class="aboutus">
                            <h5>{{ 'About Us' }}</h5>
                            {{ 'The creator of the "Lyft Your Down Payment" program and the "Drive For Your Down Payment" program- Ride Sharing drivers can get a temporary vehicle to Fund their vehicle purchase!' }}
                        </div>
                        <img src="{{ asset('img/driveitaway-logo-blue.svg') }}" alt="Drive IT AWAY"
                            style="width:200px;margin-top:18px;">
                    </div>
    ...
    <script type='text/javascript' src='https://c.la2-c1-ia2.salesforceliveagent.com/content/g/js/48.0/deployment.js'>
    </script>
    <script type='text/javascript'>
        ...
        (function() {
            ...
            if (typeof ic === "function") {
                ...
                var l = function() {
                    ...
                    s.async = true;
                    s.src = 'https://widget.intercom.io/widget/lq57p3jl';
