{{-- Cake `app/View/Layouts/driveitaway.ctp` — DriveItAway marketing shell (subset; third-party widgets gated in config/legacy.php). --}}
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ legacy_asset('driveitawaystyle.css') }}">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-pad">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="{{ rtrim(legacy_site_url(), '/') }}/">
                            <img src="{{ legacy_asset('img/driveitaway-logo-blue.svg') }}" alt="Drive IT AWAY" style="width:200px;margin-top:18px;">
                        </a>
                    </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col-md-4 col-lg-4 col-sm-12">
                    <div class="aboutus">
                        <h5>About Us</h5>
                        The creator of the "Lyft Your Down Payment" program and the "Drive For Your Down Payment" program—
