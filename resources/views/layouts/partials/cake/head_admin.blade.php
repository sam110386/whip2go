...
<script src="{{ legacy_asset('js/assets/js/plugins/forms/styling/switch.min.js') }}"></script>
<script src="{{ legacy_asset('js/jquery.validate.js') }}"></script>
<script src="{{ legacy_asset('js/assets/js/plugins/notifications/noty.min.js') }}"></script>
...
<link rel="stylesheet" href="{{ legacy_asset('css/theme2/icons/fontawesome/styles.min.css') }}">
