    ...
    <div class="page-container login-container">
        <div class="page-content">
            <div class="content-wrapper">
                <div class="content">
                    <div class="panel panel-body login-form text-danger" id="congratulation">
                        <div class="content-group">&nbsp;</div>
                        <div class="text-center">
                            <div class="col-xs-11">
                                <h4 class="content-group text-danger text-uppercase">Sorry, something went wrong. Please contact support team at {{ config('legacy.SUPPORT_PHONE', '') }}</h4>
                            </div>
                        </div>
                        <div class="content-group">&nbsp;</div>
                    </div>
