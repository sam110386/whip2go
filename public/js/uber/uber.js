...
jQuery(document).ready(function () {
    jQuery("#RideCsOrderId").select2({
        ...
        ajax: {
            url: SITE_URL+"uber/booking/bookingautocomplete",
            dataType: "json",
            type: "GET",
    ...
    jQuery("#RideReservationId").select2({
        ...
        ajax: {
            url: SITE_URL+"uber/booking/reservationautocomplete",
            dataType: "json",
            type: "GET",
            data: function (params) {
                var queryParameters = {
...
jQuery(function () {
    ...
    jQuery('#dispatchBtn').click(function () {
        if(jQuery("#RideBooking").valid()){
            ...
            jQuery.post(SITE_URL+"uber/booking/book", params, function (data) {
                if (data.status) {
                    swal({
                        title: data.message,
...
function UberCars(){
    if(jQuery("#RideBooking").valid()){
        ...
        var params = jQuery("#RideBooking").serialize();
        jQuery.post(SITE_URL+"uber/booking/getUberCars", params, function (data) {
            if (data.status) {
                let vehicles='';
