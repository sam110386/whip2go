...
class AccutradeApiController extends LegacyApiBaseController
{
    ...
    // Action stubs (CakePHP: app/Controller/AccutradeApiController.php)
    public function getAuthToken(Request $request)
    {
        // Mirrors CakePHP: app/Controller/AccutradeController.php::getAuthToken()
        $pepper = 'driveitaway';
        ...
        $now = time();
        $jwtPayload = [
            // Cake uses a different issuer/audience in local env; we keep prod values.
            'iss' => 'https://www.whip2go.com',
            'aud' => 'https://www.whip2go.com',
            'iat' => $now,
            'nbf' => $now,
            // Accutrade token expires in 6 hours in Cake.
            'exp' => $now + 6 * 3600,
            'user' => [
                'userId' => (int) $user->id,
                'token' => $token,
    ...
    {
        // Mirrors CakePHP: app/Controller/AccutradeController.php::refreshToken()
        $pepper = 'driveitaway';
    ...
    private function getAccutradeDealerId(array $dealerInfo): int
    {
        ...
        // Store on request-lifecycle for lat/lng access during save.
    ...
    private function saveAccutradeVehicleRecord(array $record): void
    {
        ...
        // vehicle_unique_id generation parity.
    ...
    {
        // Mirrors Common::getVehicleStatus() used by Cake.
        return [
            '0' => 'Unlisted',
            '1' => 'Active',
            '4' => 'Inactive',
