...
/**
 * V2 Mobile API Controller - thin wrappers calling Services2Controller.
 *
 * Every public method delegates to the corresponding Services2Controller method
 * and returns its JsonResponse directly. Version-check and X-Security header
 * validation should be handled by middleware, not inline.
 */
class Api2Controller extends Controller
{
    private string $version = 'v2.10';

    protected function services(): Services2Controller
    {
        return app(Services2Controller::class);
    }
    ...
    public function getHomeScreenText(Request $request): JsonResponse
    {
        $blocks = [
            ...
            [
                ...
                'subtitle' => 'DriveItAway is a Vehicle Flexible Lease program where you Pay-As-You-Go. Any credit is welcome. Lease for 1 month at a time. At the end of each cycle, you can renew, purchase, or return. Your choice!',
                'type' => 'test_ownership',
            ],
            [
