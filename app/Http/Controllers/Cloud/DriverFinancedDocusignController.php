...
class DriverFinancedDocusignController extends LegacyAppController
{
    use AgreementTrait;
    ...
    public function returncallback()
    {
        ...
        return view('cloud.insurance.driver_financed_docusign.returncallback');
    }
        ...
        try {
            ...
            if (!empty($quoteArr['docusign_envelope_id'])) {
                ...
                if ($envelopObj['status'] === 'completed') {
                    return redirect('/insurance/driver_financed_docusign/returncallback?event=signing_alreadycomplete');
                }
    ...
    private function getTemplateArgs(string $orderandusers): array
    {
        ...
        return [
            ...
            'envelope_args'   => [
                ...
                'ds_return_url'    => url('/insurance/driver_financed_docusign/returncallback'),
            ],
        ];
    }
}
