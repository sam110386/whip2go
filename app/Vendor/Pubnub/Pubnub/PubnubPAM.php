...
class PubnubPAM
{
    ...
    public function __construct($publish_key, $subscribe_key, $secret_key, $pnsdk)
    {
    ...
    {
        $encodedMessage = mb_convert_encoding($message, 'UTF-8', 'ISO-8859-1');
        $encodedSecret = mb_convert_encoding($this->secret_key, 'UTF-8', 'ISO-8859-1');
     ...
     * @return array
     */
    public function grant($read, $write, $channel, $auth_key, $ttl, $sessionUuid = null)
    {
     ...
     * @return array
     */
    public function audit($channel, $auth_key, $sessionUuid = null)
    {
        return $this->getRequestParams(array(
            'method' => 'audit',
            'channel' => $channel,
     ...
     * @return array
     */
    public function revoke($channel, $auth_key, $sessionUuid = null)
    {
    ...
    private function getRequestParams(array $query)
    {
        ...
        if (
            isset($query['ttl']) && (intval($query['ttl']) ||
                $query['ttl'] === 0)
        ) {
