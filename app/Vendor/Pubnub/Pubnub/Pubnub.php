...
use Exception;
use Pubnub\Pubnub\Clients\DefaultClient;
use Pubnub\Pubnub\Clients\PipelinedClient;
...
class Pubnub
{
     ...
     */
    public function detailedHistory()
    {
    ...
    {
        if (function_exists('com_create_guid') && function_exists('com_create_guid') === true) {
